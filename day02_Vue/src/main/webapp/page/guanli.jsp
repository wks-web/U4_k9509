...
//  if(o==null){
//    out.print("<script>alert('你还没有登入，超时,可以滚啦');location.href='login.html';</script>");
//  }
...
<DIV id=header class=wrap>
  ...
  <DIV class=search> 【欢迎:${user.name}】
    <LABEL class="ui-green searchs"><a href="fabu.html" title="">发布房屋信息</a></LABEL>
    <LABEL class="ui-green searchs"><a href="logina" title="">管理房屋信息</a></LABEL>
    ...
    <TABLE class=house-list>
      ...
      <A href="details.html" target="_blank">
        <img src="http://localhost:80/${h.path}" width="100" height="75" alt=""></A></SPAN></TD>
          ...
          <TD class=house-price><LABEL class=ui-green><INPUT onclick="location.href='deleteHouse?id=${h.id}'" value="删    除" type=button name=search>
          </LABEL></TD>
        </TR>
      </c:forEach>
